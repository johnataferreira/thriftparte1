...
public interface Acao {
	...
	public static int LISTAR_VERTICES 				= 12;
	public static int LISTAR_ARESTAS 				= 13;
	public static int LISTAR_VERTICES_DE_UMA_ARESTA	= 14;
	public static int LISTAR_ARESTAS_DE_UM_VERTICE 	= 15;
	public static int LISTAR_VERTICES_VIZINHOS		= 16;
